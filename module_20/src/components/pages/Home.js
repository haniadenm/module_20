...
{/* 
      ...
      <div className="card">
        ...
        <a href="https://github.com/Haniadenm/teamikea" target="_blank" className="btn btn-primary portfolio-btn">View Repository on GitHub</a>
      </div>
      <div className="card">
        ...
        <a href="https://haniadenm.github.io/project-1/html" target="_blank" className="btn btn-primary portfolio-btn">View Project</a>
        <a href="https://github.com/haniadenm/project-1" target="_blank" className="btn btn-primary portfolio-btn">View Repository on GitHub</a>
      </div>
      <div className="card">
        ...
        <a href="https://haniadenm.github.io/06-weather-dashboard" target="_blank" className="btn btn-primary portfolio-btn">View Project</a>
        <a href="https://github.com/haniadenm/haniadenm.github.io/tree/master/06-weather-dashboard" target="_blank" className="btn btn-primary portfolio-btn">View Repository on GitHub</a>
      </div>
      <div className="card">
        ...
        <a href="https://haniadenm.github.io/04-quiz-game" target="_blank" className="btn btn-primary portfolio-btn">View Project</a>
        <a href="https://github.com/haniadenm/haniadenm.github.io/tree/master/04-quiz-game" target="_blank" className="btn btn-primary portfolio-btn">View Repository on GitHub</a>
      </div>
    </div>
  );
}
